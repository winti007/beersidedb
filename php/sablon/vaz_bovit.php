 ...
 */ 
      ...
      public function Sablondef($Sablonnev)
      {
            ...
            {            
                ...
                break;
                case "Nyitocsomag":
                $Vissza=$this->Futtat(Csomag_azon)->Almenulistaz();
                break;
                ...
                case "Navmenu":
                    ...
                    $Obj=$this->ObjektumLetrehoz(Felso_azon($Nyelv));
                ...
                case "Nyitoprogajanl":
                    ...
                    $Nyelv=$this->Nyelvadpub();
                    $Obj=$this->ObjektumLetrehoz(Prog_azon($Nyelv));
                    $Ered=$Obj->Futtatgy("CSOPORT",null,null,null," and AKTIV_I='1'")->Adatlistkozep_publ(false);         
                    $Vissza["Program"]=$Ered["Eredm"];
                    $Vissza["Program_data"]=$Obj->Adatlistkozep_publ(false);
            ...
            /*    
                case "Alul":
                    ...
                    $Nyelv=$this->Nyelvadpub();
                    $Obj=$this->ObjektumLetrehoz(Also_azon);
                    $Ered=$Obj->Futtatgy("CSOPORT",null,null,null," and AKTIV_I='1'")->Adatlistkozep_publ(0);         
                    $Vissza["Menu"]=$Ered["Eredm"];
 ...
 */         
        ...
        public function Adatlist_adm()
        {
                ...
                {   
                    ...
                    {
                        $Eredmeny["EGYEB"][]=array("Nev"=>$ertek["Nev"],"Link"=>$ertek["Link"]);    
                    }
                }
...
$szov= str_replace("%u0151","ő", $szov);
       ...
       function Jelenhetnavba()
        ...
        public function Karbatarto()
        {
                ...
                parent::Karbatarto();
/*
               $Regiek=self::$Sql->Lekerst("select AZON_I from RENDELES where (DATE_SUB(now(), INTERVAL '1' DAY)>REND_ALLAPOT_MIKOR0_D) and (REND_ALLAPOT_MIKOR0_D>'2002-12-12 12:12' ) and (REND_ALLAPOT_I=0) limit 0,30");
